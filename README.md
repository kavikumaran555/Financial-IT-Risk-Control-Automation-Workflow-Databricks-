...
This project builds a simple financial risk analysis workflow using Databricks and PySpark.
...
connects multiple datasets
detects IT + banking + financial risk
simple rule-based risk scoring
ready for dashboards / monitoring
